...
# -*- coding: utf-8 -*-
#
# pnnl-buildingid: tests/test_v1.py
#
...
class MyTestCase(unittest.TestCase):
    ...
    def test_encode(self):
        with open('test_data/encode_and_decode.csv', mode='r') as csvfile:
            ...
            for row in reader:
                ...
                self.assertEqual(buildingid.v1.encode(code_area.latitudeLo, code_area.longitudeLo, code_area.latitudeHi, code_area.longitudeHi, child.latitudeCenter, child.longitudeCenter, codeLength=code_area.codeLength), code)
    ...
    def test_isValid(self):
        with open('test_data/isValid.v1.csv', mode='r') as csvfile:
            reader = csv.DictReader(csvfile)
            ...
            for row in reader:
                ...
                self.assertEqual(buildingid.v1.isValid(code), boolval)
    ...
    def test_wkt(self):
        with open('test_data/encode_and_decode.csv', mode='r') as csvfile:
            ...
            for row in reader:
                ...
                self.assertEqual(buildingid.v1.encode(*buildingid.wkt.parse(the_geom), codeLength=int(row['codeLength'])), code)

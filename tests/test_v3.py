...
# -*- coding: utf-8 -*-
#
# pnnl-buildingid: tests/test_v3.py
#
    ...
    def test_decode(self):
        with open('test_data/encode_and_decode.csv', mode='r') as csvfile:
            ...
            for row in reader:
                ...
                self.assertEqualCodeArea(buildingid.v3.decode(code), code_area, tolerance=float(row['tolerance']), precision=int(row['precision']))
    ...
    def test_encode(self):
        with open('test_data/encode_and_decode.csv', mode='r') as csvfile:
            ...
            for row in reader:
                ...
                self.assertEqual(buildingid.v3.encode(code_area.latitudeLo, code_area.longitudeLo, code_area.latitudeHi, code_area.longitudeHi, child.latitudeCenter, child.longitudeCenter, codeLength=code_area.codeLength), code)
    ...
    def test_encodeCodeArea(self):
        with open('test_data/encode_and_decode.csv', mode='r') as csvfile:
            ...
            for row in reader:
                ...
                self.assertEqual(buildingid.v3.encodeCodeArea(code_area), code)

    def test_isValid(self):
        with open('test_data/isValid.v3.csv', mode='r') as csvfile:
            reader = csv.DictReader(csvfile)
            ...
            for row in reader:
                ...
                self.assertEqual(buildingid.v3.isValid(code), boolval)
    ...
    def test_wkt(self):
        with open('test_data/encode_and_decode.csv', mode='r') as csvfile:
            ...
            for row in reader:
                ...
                self.assertEqual(buildingid.v3.encode(*buildingid.wkt.parse(the_geom), codeLength=int(row['codeLength'])), code)
